        ...
        function processResponse(data) {
            ...
            function buildsPerDay(data, cb) {
                ...
                cb({
                    ...
                    unstable: countBuilds(unstable(data))
                ...
                function failed(data) {
                    return _.filter(data, function (build) {
                        return build.endTime >= fifteenDays.getTime() && (build.buildStatus === 'Failure') && (build.buildStatus !== 'InProgress');
                    });
                }
                function unstable(data){
                    return _.filter(data, function (build) {
                        return build.endTime >= fifteenDays.getTime() && (build.buildStatus === 'Unstable') ;
                    });
                }
